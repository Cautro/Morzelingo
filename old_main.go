...
func updateAllFriendshipStreaks(username string) error {
	...
	if len(currentUser.Friends) == 0 {
		return nil // РЅРµ СЃ РєРµРј РѕР±РЅРѕРІР»СЏС‚СЊ
	}

	// Р”Р»СЏ РєР°Р¶РґРѕРіРѕ РґСЂСѓРіР° РїСЂРѕРІРµСЂСЏРµРј, Р±С‹Р» Р»Рё РѕРЅ СЃРµРіРѕРґРЅСЏ Р°РєС‚РёРІРµРЅ
	today := time.Now().UTC().Format("2006-01-02")
	for _, friend := range currentUser.Friends {
		...
		// Р•СЃР»Рё РґСЂСѓРі С‚РѕР¶Рµ СЃРµРіРѕРґРЅСЏ Р·Р°С…РѕРґРёР» (LastLogin == today)
		if friendUser.LastLogin == today {
			// РѕР±РЅРѕРІР»СЏРµРј СЃРѕРІРјРµСЃС‚РЅС‹Р№ СЃС‚СЂРёРє
...
func addToFriends(username string) error {
	...
	// РЅР°С…РѕРґРёРј С‚РµРєСѓС‰РµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
	for i := range users {
		if users[i].Username == username {
			currentUser = &users[i]
			break
	...
	// РµСЃР»Рё РЅРµС‚ СЂРµС„РµСЂР°Р»Р° вЂ” РІС‹С…РѕРґРёРј
	if currentUser.ReferredBy == "" {
		return nil
	}

	// РёС‰РµРј РїСЂРёРіР»Р°СЃРёРІС€РµРіРѕ РїРѕ РєРѕРґСѓ
	for i := range users {
	...
	// РґРѕР±Р°РІР»СЏРµРј С‚РµРєСѓС‰РµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РІ РґСЂСѓР·СЊСЏ РїСЂРёРіР»Р°СЃРёРІС€РµРіРѕ
	inviter.Friends = append(inviter.Friends, currentUser.Username)

	// РґРѕР±Р°РІР»СЏРµРј РїСЂРёРіР»Р°СЃРёРІС€РµРіРѕ РІ РґСЂСѓР·СЊСЏ С‚РµРєСѓС‰РµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
...
func main() {
	...
	res.POST("/api/register", func(c *gin.Context) {
		...
		users, err := readUsers()
		if err != nil {
			c.JSON(500, gin.H{"error": "Failed to read users", "details": err.Error(), "message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° users.json. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚."})
			return
		}
		...
		for _, u := range users {
			if u.Username == user.Username {
				c.JSON(400, gin.H{"error": "User exists", "message": "РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ СЃ С‚Р°РєРёРј РёРјРµРЅРµРј СѓР¶Рµ СЃСѓС‰РµСЃС‚РІСѓРµС‚. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РІС‹Р±РµСЂРёС‚Рµ РґСЂСѓРіРѕРµ РёРјСЏ."})
				return
			}
		}
		...
		for _, u := range users {
			if u.Email == user.Email {
				c.JSON(400, gin.H{"error": "Email already exists", "message": "Р­Р»РµРєС‚СЂРѕРЅРЅР°СЏ РїРѕС‡С‚Р° СѓР¶Рµ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РІС‹Р±РµСЂРёС‚Рµ РґСЂСѓРіСѓСЋ."})
				return
			}
		}
		...
		if err := safeSaveUsers(users); err != nil {
			c.JSON(500, gin.H{"error": "Failed to save users", "details": err.Error(), "message": "РџСЂРѕР±Р»РµРјР° СЃРѕС…СЂР°РЅРµРЅРёСЏ С„Р°Р№Р»Р° users.json. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» РґРѕСЃС‚СѓРїРµРЅ РґР»СЏ Р·Р°РїРёСЃРё."})
			return
		}
	...
	res.POST("/api/login", func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(500, gin.H{
				"message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° users.json. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚.",
		...
		if foundUser == nil {
			c.JSON(401, gin.H{
				"message": "РќРµРІРµСЂРЅС‹Рµ РёРјСЏ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РёР»Рё РїР°СЂРѕР»СЊ. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ РІС‹ РІРІРѕРґРёС‚Рµ РїСЂР°РІРёР»СЊРЅС‹Рµ РґР°РЅРЅС‹Рµ.",
		...
		if err != nil {
			c.JSON(500, gin.H{
				"message": "РЈСЃРїРµС€РЅС‹Р№ РІС…РѕРґ, РЅРѕ РЅРµ СѓРґР°Р»РѕСЃСЊ СЃРѕР·РґР°С‚СЊ С‚РѕРєРµРЅ. РџРѕРїСЂРѕР±СѓР№С‚Рµ СЃРЅРѕРІР°.",
	...
	res.GET("/api/profile", authMiddleware(), func(c *gin.Context) {
		...
		if !exists {
			c.JSON(500, gin.H{"error": "username not found in context", "message": "Р’РЅСѓС‚СЂРµРЅРЅСЏСЏ РѕС€РёР±РєР° СЃРµСЂРІРµСЂР°. РџРѕРїСЂРѕР±СѓР№С‚Рµ СЃРЅРѕРІР°."})
			return
		}
		...
		for _, u := range users {
			...
			if u.Username == username {
				c.JSON(200, gin.H{
					...
					"coins":                u.Coins,
					"items":                u.Items,
					"message":              "РџСЂРѕС„РёР»СЊ СѓСЃРїРµС€РЅРѕ Р·Р°РіСЂСѓР¶РµРЅ.",
					"streak":               u.Streak,
		...
		c.JSON(404, gin.H{"error": "user not found", "message": "РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РЅРµ РЅР°Р№РґРµРЅ. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ РІС‹ РёСЃРїРѕР»СЊР·СѓРµС‚Рµ РїСЂР°РІРёР»СЊРЅС‹Р№ С‚РѕРєРµРЅ Рё С‡С‚Рѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЊ СЃСѓС‰РµСЃС‚РІСѓРµС‚."})
	})
	...
	res.POST("/api/complete-lesson", authMiddleware(), func(c *gin.Context) {
		...
		if err := c.ShouldBindJSON(&input); err != nil {
			c.JSON(400, gin.H{"error": "Invalid input", "details": err.Error(), "message": "РќРµРІРµСЂРЅС‹Рµ РґР°РЅРЅС‹Рµ. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ РІС‹ РѕС‚РїСЂР°РІР»СЏРµС‚Рµ РїСЂР°РІРёР»СЊРЅС‹Р№ JSON СЃ РїРѕР»РµРј lesson_id."})
			return
		}
		...
		if err != nil {
			c.JSON(500, gin.H{"error": "Failed to read lessons", "details": err.Error(), "message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° lessons.json. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚."})
			return
		}
		...
		for i, u := range users {
			...
			if u.Username == username {
				if input.LessonID != LessonDone+1 {
					c.JSON(400, gin.H{"error": "Invalid lesson order", "message": "РќРµРІРµСЂРЅС‹Р№ РїРѕСЂСЏРґРѕРє СѓСЂРѕРєРѕРІ. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ РІС‹ Р·Р°РІРµСЂС€Р°РµС‚Рµ СѓСЂРѕРєРё РІ РїСЂР°РІРёР»СЊРЅРѕР№ РїРѕСЃР»РµРґРѕРІР°С‚РµР»СЊРЅРѕСЃС‚Рё."})
					return
				}
	...
	res.GET("/api/lessons/:id", authMiddleware(), func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(500, gin.H{
				"message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° СЃ СѓСЂРѕРєР°РјРё. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚.",
		...
		c.JSON(404, gin.H{"error": "Lesson not found", "message": "РЈСЂРѕРє РЅРµ РЅР°Р№РґРµРЅ. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РїСЂРѕРІРµСЂСЊС‚Рµ ID СѓСЂРѕРєР°."})
	})
	...
	res.POST("/api/practice", authMiddleware(), func(c *gin.Context) {
		...
		if lang == "ru" && strings.ContainsAny(letters, "ABCDEFGHIJKLMNOPQRSTUVWXYZ") {
			c.JSON(400, gin.H{
				"error": "РСЃРїРѕР»СЊР·СѓР№С‚Рµ СЂСѓСЃСЃРєРёРµ Р±СѓРєРІС‹ РґР»СЏ lang=ru",
			})
			return
		}
	...
	res.POST("/api/practice/submit", authMiddleware(), func(c *gin.Context) {
		...
		for i, u := range users {
			...
			if u.Username == username {
				...
				if err := updateAllFriendshipStreaks(username); err != nil {
					// Р»РѕРіРёСЂСѓРµРј РѕС€РёР±РєСѓ, РЅРѕ РЅРµ РїСЂРµСЂС‹РІР°РµРј РѕС‚РІРµС‚
					fmt.Println("Error updating friendship streaks:", err)
				}
	...
	res.GET("/api/freemode", authMiddleware(), func(c *gin.Context) {
		...
		default:
			c.JSON(400, gin.H{
				"error": "Invalid mode",
				"message": "РќРµРІРµСЂРЅС‹Р№ СЂРµР¶РёРј. РџРѕР¶Р°Р»СѓР№СЃС‚Р°, РІС‹Р±РµСЂРёС‚Рµ 'text' РёР»Рё 'morse'.",
			})
		}
	})
	...
	res.GET("/api/shop", authMiddleware(), func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(500, gin.H{
				"message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° РјР°РіР°Р·РёРЅР°. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚.",
	...
	res.GET("/api/achievements", authMiddleware(), func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(500, gin.H{
				"message": "РџСЂРѕР±Р»РµРјР° РѕС‚РєСЂС‹С‚РёСЏ С„Р°Р№Р»Р° РґРѕСЃС‚РёР¶РµРЅРёР№. РЈР±РµРґРёС‚РµСЃСЊ, С‡С‚Рѕ С„Р°Р№Р» СЃСѓС‰РµСЃС‚РІСѓРµС‚ Рё РёРјРµРµС‚ РїСЂР°РІРёР»СЊРЅС‹Р№ С„РѕСЂРјР°С‚.",
	...
	res.GET("/api/friends", authMiddleware(), func(c *gin.Context) {
		...
		for _, friend := range currentUser.Friends {
			// РЅР°Р№РґС‘Рј РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ-РґСЂСѓРіР°
			var friendUser *User
			for _, u := range users {
			...
			// РЅР°Р№РґС‘Рј СЃРѕРІРјРµСЃС‚РЅС‹Р№ СЃС‚СЂРёРє
			streak := 0
			lastActive := ""
			for _, s := range streaks {
	...
	res.POST("/api/add-to-friend", authMiddleware(), func(c *gin.Context) {
		...
		// Р‘С‹СЃС‚СЂС‹Р№ РґРѕСЃС‚СѓРї РїРѕ username
		usersMap := make(map[string]*User)
		for i := range users {
			usersMap[users[i].Username] = &users[i]
		}

		// РС‰РµРј РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РїРѕ СЂРµС„РµСЂР°Р»СЊРЅРѕРјСѓ РєРѕРґСѓ
		var friendUser *User
		for i := range users {
		...
		if friendUser != nil {
			...
			// Р”РѕР±Р°РІР»СЏРµРј РґСЂСѓРі РґСЂСѓРіР° Р±РµР· РґСѓР±Р»РµР№
		...
		// Р¤РѕСЂРјРёСЂСѓРµРј friendsList Р±РµР· РґСѓР±Р»РµР№
		currUser := usersMap[username]
	...
	res.POST("/api/delete-friend", authMiddleware(), func(c *gin.Context) {
		...
		if err := c.ShouldBindJSON(&deleteReq); err != nil {
			c.JSON(400, gin.H{"error": "РќРµРІРµСЂРЅС‹Р№ С„РѕСЂРјР°С‚ Р·Р°РїСЂРѕСЃР°"})
			return
		}
		...
		for i := range users {
			if users[i].Username == deleteReq.Username {
				c.JSON(400, gin.H{"error": "РќРµР»СЊР·СЏ СѓРґР°Р»РёС‚СЊ СЃР°РјРѕРіРѕ СЃРµР±СЏ"})
				friendUser = &users[i]
				break
			}		
		}
		...
		if friendUser == nil {
			c.JSON(404, gin.H{"error": "РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ СЃ С‚Р°РєРёРј РєРѕРґРѕРј РЅРµ РЅР°Р№РґРµРЅ"})
			return
		}
		...
		if err := safeSaveUsers(users); err != nil {
			c.JSON(500, gin.H{"error": "РќРµ СѓРґР°Р»РѕСЃСЊ СЃРѕС…СЂР°РЅРёС‚СЊ РёР·РјРµРЅРµРЅРёСЏ"})
			return
		}

		c.JSON(200, gin.H{
			"message": "Р”СЂСѓРі СѓСЃРїРµС€РЅРѕ СѓРґР°Р»РµРЅ",
