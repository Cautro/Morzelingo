...
class FreemodeFlowPage extends StatefulWidget {
  const FreemodeFlowPage({super.key});

  @override
  State<FreemodeFlowPage> createState() => _FreemodeFlowPageState();
}

class _FreemodeFlowPageState extends State<FreemodeFlowPage> {
  @override
